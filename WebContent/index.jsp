...
<head>
    ...
    <!-- Site Properties -->
    <title>HostelWorld | 在线酒店预订</title>
...
<div class="ui large top fixed hidden menu">
    <div class="ui container">
        <a class="active item" href="index.jsp">会员</a>
        <a class="item" href="indexInn.jsp">客栈</a>
        <a class="item" href="indexmgr.jsp">管理</a>
...
<!-- Page Contents -->
<div class="pusher">
    <div class="ui inverted vertical masthead center aligned segment" style="background-image: url('assets/cover.jpeg');margin-top: 0px">
        ...
        <div class="ui text container">
            ...
            <div class="ui buttons huge">
                <button class="ui button inverted" onclick="showLogin()">登录</button>
                <div class="or"></div>
                <button class="ui primary button" onclick="showReg()">注册</button>
            </div>
        </div>
        </div>
...
<div class="ui modal" id="loginDia" style="width: 30%;margin-left: -15%;">
    ...
    <div class="actions">
        <div class="ui button negative">忘记密码？</div>
        <div class="ui button primary" onclick="LoginCheck()" >登录</div>
    </div>
</div>



<div class="ui modal" id="RegDia" style="width: 30%;margin-left: -15%;">
    <i class="close icon"></i>
    <div class="header">
        会员注册
    </div>
<form id="regform" class="ui large form" style="margin-top: 40px" action="/HostelWorld/CusReg" method="post">
    <div class="ui left icon input" style="margin-left: 20%;margin-top: 20px">
        <input id="regEmail" type="text" name="email" placeholder="邮箱">
        <i class="mail icon"></i>
    </div>

    <div class="ui left icon input" style="margin-left: 20%;margin-top: 20px">
        <input id="regName" type="text" name="username" placeholder="用户名">
        <i class="user icon"></i>
    </div>

    <div class="ui left icon input" style="margin-left: 20%;margin-top: 20px;margin-bottom: 0px">
        <input id="regPsw" type="password" name="psw" placeholder="设置密码">
        <i class="privacy icon"></i>
    </div>

    <div class="ui left icon input" style="margin-left: 20%;margin-top: 20px;margin-bottom: 20px">
        <input id="regPswCon" type="password" name="pswconfirm" placeholder="确认密码">
        <i class="privacy icon"></i>
    </div>
    
    </form>

    <p id="regError" style="margin-left: 20%;margin-top: 10px;margin-bottom: 20px;color: red"></p>


    <div class="actions">
        <div class="ui button negative">取消</div>
        <div class="ui button primary" onclick="RegCheck()">注册</div>
    </div>
</div>
...
<div id="ressuccess" class="ui modal small">
    ...
    <div class="actions">
        ...
        <div class="ui green right labeled icon button" onclick="goLogin()">
            去登录 
...
<script type='text/javascript' src='assets/js/showClientLogin.js'></script>
