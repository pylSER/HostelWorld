...
<head>
    ...
    <!-- Site Properties -->
    <title>HostelWorld | 在线客栈管理</title>
...
<div class="ui large top fixed hidden menu">
    <div class="ui container">
        ...
        <a class="active  item" href="indexInn.jsp">客栈</a>
...
<div class="pusher">
        ...
        <div style="height: 580px;background-color: rgba(0,0,0,0.5)">
            ...
            <div class="ui text container">
                ...
                <div class="ui buttons huge">
                    ...
                    <div class="or"></div>
                    <button class="ui primary button" onclick="jumpToReg()" >开店申请</button>
                </div>
            </div>
        </div>
    ...
    <div class="ui modal" id="loginDia" style="width: 30%;margin-left: -15%;">
        ...
        <div class="actions">
            ...
            <div class="ui button primary" onclick="InnLoginCheck()">登录</div>
        </div>
    </div>
...
<script>
    function jumpToReg() {
        window.location.href="InnReg.jsp";
    }
